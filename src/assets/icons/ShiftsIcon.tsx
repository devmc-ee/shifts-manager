export const ShiftsIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48">
      <g fill="currentColor">
        <path fillRule="evenodd" d="M35 40a5 5 0 1 0 0-10a5 5 0 0 0 0 10Zm0 2a7 7 0 1 0 0-14a7 7 0 0 0 0 14Z" clipRule="evenodd" />
        <path
          fillRule="evenodd"
        ...
        <path
          fillRule="evenodd"
          d="M28 9H16v3a1 1 0 1 1-2 0V9H9a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h24a2 2 0 0 0 2-2v-5a2 2 0 0 0-2-2h-3v3a1 1 0 1 1-2 0V9Z"
          clipRule="evenodd"
        />
        <path fillRule="evenodd" d="M36 18H8v-2h28v2Z" clipRule="evenodd" />
        <path d="M12 7a1 1 0 1 1 2 0v4a1 1 0 1 1-2 0V7Zm14 0a1 1 0 1 1 2 0v4a1 1 0 1 1-2 0V7Z" />
      </g>
    </svg>
  );
};
